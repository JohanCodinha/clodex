...
const OPENAI_OAUTH_MODEL_SEEDS: OAuthModelSeed[] = [
  ...
  // Rolled out to ChatGPT plans in stages during 2026-09; until the Codex catalog
  // listed it for an account the backend rejected it with "not supported when using
  // Codex with a ChatGPT account", so discovery decides when it appears. It also
  // requires a client version of at least 0.153.0 (see CODEX_RESPONSES_LITE_VERSION).
